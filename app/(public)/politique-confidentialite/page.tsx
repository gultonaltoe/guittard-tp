...
import { DEFAULT_POLITIQUE_CONFIDENTIALITE } from "@/lib/legalContentDefaults";
import type { ContenuSite, SiteSettings } from "@/lib/types";

export const dynamic = "force-dynamic";

export const metadata: Metadata = {
  title: "Politique de confidentialité | Guittard TP & Terrassement",
  description:
    "Politique de confidentialité et gestion des cookies du site Guittard TP & Terrassement.",
  robots: "index, follow",
};
  ...
  try {
    ...
    const [{ data: settings }, { data: contenu }] = await Promise.all([
      ...
      supabase
        .from("contenu_site")
        .select("*")
        .eq("cle", "politique_confidentialite")
        .single(),
    ]);
    return {
    ...
    <>
      ...
      <main>
        ...
        <section className="mx-auto max-w-3xl px-4 py-10 md:py-16 text-neutral-700">
          {renderLegalMarkdown(contenu || DEFAULT_POLITIQUE_CONFIDENTIALITE)}
        </section>
      </main>
